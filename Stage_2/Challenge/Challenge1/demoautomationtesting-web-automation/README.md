...
│   └── main
│       └── java
│           └── com.danielbobes.demoautomationtesting
...
│       ├── java
│       │   └── com.danielbobes.demoautomationtesting
│       │       └── runner                              # Motor de ejecución de las pruebas
...
2. Ejecuta los siguientes comandos:
    ...
    ```
El reporte detallado se generará en la ruta `target/cucumber-reports/main-report.html`.