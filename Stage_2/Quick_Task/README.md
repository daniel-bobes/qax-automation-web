# 🧪 Web Automation: Quick Task - Stage 2

Este directorio contiene la resolución de la tarea de automatización Web, dividida en dos bloques principales: identificación de estrategias de localización e implementación de acciones avanzadas con Selenium WebDriver.

🎯 Objetivos de la Tarea
1. Dominio de Localizadores: Mapeo de flujos E2E y elementos complejos (Shadow DOM, IFrames).
2. Acciones Avanzadas: Implementación de interacciones de usuario de alta fidelidad (Drag & Drop, Hover, Context Clic, etc.).
